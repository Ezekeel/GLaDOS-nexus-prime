...
#ifdef CONFIG_OMAP_OCFREQ_1400
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1400, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
#ifdef CONFIG_OMAP_OCFREQ_1600
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV_OC1600, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
#endif
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
